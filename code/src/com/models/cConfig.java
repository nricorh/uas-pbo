...
public class cConfig {
    ...
    // ini untuk mendefinisikan koneksi ke database
    // private static final String koneksi = "com.mysql.jdbc.Driver"; 
    private static final String url = "jdbc:mysql://localhost:3306/uaspbo";
    ...
    public static boolean delRent(String rentId ) {
        ...
        try {
            ...
            statement.close();
            connect.close();
            System.out.println("SUCCESS - Rent has been deleted");
        } catch (Exception e) {
